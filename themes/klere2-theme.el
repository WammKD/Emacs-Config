 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'klere2
	...
	`(cursor ((,class (:background ,bg3))))
        ...
        `(mode-line-inactive ((,class (:box (:line-width 1 :color nil :style pressed-button) :foreground ,fg4 :background ,bg2 :weight normal))))
...
(provide-theme 'klere2)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; klere2-theme.el ends here
