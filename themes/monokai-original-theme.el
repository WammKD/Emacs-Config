;;; monokai-original-theme.el --- A fruity color theme for Emacs.
...
;; - https://github.com/pope/personal/blob/master/etc/emacs.d/monokai-original-theme.el
;;
...
(unless (>= emacs-major-version 24)
  (error "The monokai-original theme requires Emacs 24 or later!"))

(deftheme monokai-original "The Monokai-Original colour theme")

(defgroup monokai-original nil
  "Monokai-Original theme options.
The theme has to be reloaded after changing anything in this group."
  :group 'faces)

(defcustom monokai-original-distinct-fringe-background nil
  "Make the fringe background different from the normal background color.
Also affects 'linum-mode' background."
  :type 'boolean
  :group 'monokai-original)

(defcustom monokai-original-use-variable-pitch t
  "Use variable pitch face for some headings and titles."
  :type 'boolean
  :group 'monokai-original)

(defcustom monokai-original-high-contrast-mode-line nil
  "Make the active/inactive mode line stand out more."
  :type 'boolean
  :group 'monokai-original)

(defcustom monokai-original-height-minus-1 0.8
  "Font size -1."
  :type 'number
  :group 'monokai-original)

(defcustom monokai-original-height-plus-1 1.1
  "Font size +1."
  :type 'number
  :group 'monokai-original)

(defcustom monokai-original-height-plus-2 1.15
  "Font size +2."
  :type 'number
  :group 'monokai-original)

(defcustom monokai-original-height-plus-3 1.2
  "Font size +3."
  :type 'number
  :group 'monokai-original)

(defcustom monokai-original-height-plus-4 1.3
  "Font size +4."
  :type 'number
  :group 'monokai-original)
...
(let* ((class                    '((class color) (min-colors 257)))
       ...
       (gray-l                   "#6b6b6b")
       ;; Adaptive colors
       (monokai-original-fg               "#F8F8F8")
       (monokai-original-bg               "#272822")
       (monokai-original-hl-line          "#3E3D31")
       (monokai-original-hl               "#49483E")
       (monokai-original-emph             "#F8F8F0")
       (monokai-original-comments         "#75715E")
       ;; Adaptive higher/lower contrast accented colors
       (monokai-original-fg-hc            "#141414")
       (monokai-original-fg-lc            "#171A0B")
       ...
       (s-variable-pitch         (if monokai-original-use-variable-pitch
                                     'variable-pitch 'default))
       (s-fringe-bg              (if monokai-original-distinct-fringe-background
                                     monokai-original-hl monokai-original-bg))
       (s-mode-line-fg           (if monokai-original-high-contrast-mode-line
                                     monokai-original-bg monokai-original-fg))
       (s-mode-line-bg           (if monokai-original-high-contrast-mode-line
                                     monokai-original-fg monokai-original-hl-line))
       (s-mode-line-buffer-id-fg (if monokai-original-high-contrast-mode-line
                                     'unspecified green))
       (s-mode-line-inactive-fg  (if monokai-original-high-contrast-mode-line
                                     monokai-original-fg monokai-original-comments))
       (s-mode-line-inactive-bg  (if monokai-original-high-contrast-mode-line
                                     monokai-original-hl-line monokai-original-bg))
       (s-mode-line-inactive-bc  (if monokai-original-high-contrast-mode-line
                                     monokai-original-fg monokai-original-hl-line))
       ...
       ;; Adaptive colors
       (terminal-monokai-original-fg               "#F5F5F5")
       (terminal-monokai-original-bg               "#1B1E1C")
       (terminal-monokai-original-hl-line          "#212121")
       (terminal-monokai-original-hl               "#303030")
       (terminal-monokai-original-emph             "#FFFAFA")
       (terminal-monokai-original-comments         "#8B8878")
       ;; Adaptive higher/lower contrast accented colors
       (terminal-monokai-original-fg-hc            "#171A0B")
       (terminal-monokai-original-fg-lc            "#141414")
       ;; High contrast colors
       ...
       ;; customize based face properties
       (terminal-s-variable-pitch         (if monokai-original-use-variable-pitch
                                              'variable-pitch 'default))
       (terminal-s-fringe-bg              (if monokai-original-distinct-fringe-background
                                              terminal-monokai-original-hl terminal-monokai-original-bg))
       (terminal-s-mode-line-fg           (if monokai-original-high-contrast-mode-line
                                              terminal-monokai-original-bg terminal-monokai-original-fg))
       (terminal-s-mode-line-bg           (if monokai-original-high-contrast-mode-line
                                              terminal-monokai-original-fg terminal-monokai-original-hl-line))
       (terminal-s-mode-line-buffer-id-fg (if monokai-original-high-contrast-mode-line
                                              'unspecified terminal-green))
       (terminal-s-mode-line-inactive-fg  (if monokai-original-high-contrast-mode-line
                                              terminal-monokai-original-fg terminal-monokai-original-comments))
       (terminal-s-mode-line-inactive-bg  (if monokai-original-high-contrast-mode-line
                                              terminal-monokai-original-hl-line terminal-monokai-original-bg))
       (terminal-s-mode-line-inactive-bc  (if monokai-original-high-contrast-mode-line
                                              terminal-monokai-original-fg terminal-monokai-original-hl-line)))
  ...
  (custom-theme-set-faces
   ...
   ;; basic coloring
   `(default
      ((,class (:foreground ,monokai-original-fg
                            :background ,monokai-original-bg))
       (,terminal-class (:foreground ,terminal-monokai-original-fg
                                     :background ,terminal-monokai-original-bg))))

   `(shadow
     ((,class (:foreground ,monokai-original-comments))
      (,terminal-class (:foreground ,terminal-monokai-original-comments))))

   `(match
     ((,class (:background ,monokai-original-hl
                           :foreground ,monokai-original-emph
                           :weight bold))
      (,terminal-class (:background ,terminal-monokai-original-hl
                                    :foreground ,terminal-monokai-original-emph
                                    :weight bold))))

   `(cursor
     ((,class (:foreground ,monokai-original-bg
                           :background ,monokai-original-fg
                           :inverse-video t))
      (,terminal-class (:foreground ,terminal-monokai-original-bg
                                    :background ,terminal-monokai-original-fg
                                    :inverse-video t))))
   ...
   `(cua-global-mark
     ((,class (:background ,yellow
                           :foreground ,monokai-original-bg))
      (,terminal-class (:background ,terminal-yellow
                                    :foreground ,terminal-monokai-original-bg))))
   ...
   `(cua-rectangle-noselect
     ((,class (:inherit region
                        :background ,monokai-original-hl
                        :foreground ,monokai-original-comments))
      (,terminal-class (:inherit region
                                 :background ,terminal-monokai-original-hl
                                 :foreground ,terminal-monokai-original-comments))))
   ...
   `(ecb-source-in-directories-buffer-face
     ((,class (:inherit ecb-directories-general-face
                        :foreground ,monokai-original-fg))
      (,terminal-class (:inherit ecb-directories-general-face
                                 :foreground ,terminal-monokai-original-fg))))
   ...
   `(ecb-tree-guide-line-face
     ((,class (:inherit ecb-default-general-face
                        :foreground ,monokai-original-hl
                        :height 1.0))
      (,terminal-class (:inherit ecb-default-general-face
                                 :foreground ,terminal-monokai-original-hl
                                 :height 1.0))))

   ;; ee
   `(ee-bookmarked
     ((,class (:foreground ,monokai-original-emph))
      (,terminal-class (:foreground ,terminal-monokai-original-emph))))
   ...
   `(header-line
     ((,class (:inverse-video unspecified
      ...
      (,terminal-class (:inverse-video unspecified
                                       ...
                                       :background ,terminal-monokai-original-hl
                                       :box (:line-width 1
                                                         :color ,terminal-monokai-original-hl
                                                         :style unspecified)))))
   ...
   `(vertical-border
     ((,class (:foreground ,monokai-original-hl))
      (,terminal-class (:foreground ,terminal-monokai-original-hl))))
   ...
   `(font-latex-italic-face
     ((,class (:inherit italic :foreground ,monokai-original-emph))
      (,terminal-class (:inherit italic :foreground ,terminal-monokai-original-emph))))
   ...
   `(font-latex-sectioning-0-face
     ((,class (:inherit font-latex-sectioning-1-face
                        :height ,monokai-original-height-plus-1))
   ...
   `(font-latex-slide-title-face
     ((,class (:inherit (,s-variable-pitch font-lock-type-face)
                        :weight bold
                        :height ,monokai-original-height-plus-3))
   ...
   `(font-latex-subscript-face
     ((,class (:height ,monokai-original-height-minus-1))
      (,terminal-class (:height ,monokai-original-height-minus-1))))
   ...
   `(cfw:face-title
     ((,class (:inherit ,s-variable-pitch
                        :foreground ,yellow
                        :weight bold
                        :height ,monokai-original-height-plus-4))
      (,terminal-class (:inherit ,terminal-s-variable-pitch
                                 :foreground ,terminal-yellow
                                 :weight bold
                                 :height ,monokai-original-height-plus-4))))
   ...
   `(ctbl:face-cell-select
     ((,class (:background ,monokai-original-hl
                           :foreground ,monokai-original-emph
                           :underline ,monokai-original-emph
                           :weight bold))
      (,terminal-class (:background ,terminal-monokai-original-hl
                                    :foreground ,terminal-monokai-original-emph
                                    :underline ,terminal-monokai-original-emph
                                    :weight bold))))
   ...
   `(diff-header
     ((,class (:background ,monokai-original-bg))
      (,terminal-class (:background ,terminal-monokai-original-bg))))
   ...
   `(ediff-even-diff-A
     ((,class (:background ,monokai-original-comments
                           :foreground ,monokai-original-fg-lc ))
      (,terminal-class (:background ,terminal-monokai-original-comments
                                    :foreground ,terminal-monokai-original-fg-lc ))))

   `(ediff-odd-diff-A
     ((,class (:background ,monokai-original-comments
                           :foreground ,monokai-original-fg-hc ))
      (,terminal-class (:background ,terminal-monokai-original-comments
                                    :foreground ,terminal-monokai-original-fg-hc ))))
   ...
   `(gnus-x-face
     ((,class (:background ,monokai-original-fg
                           :foreground ,monokai-original-bg))
      (,terminal-class (:background ,terminal-monokai-original-fg
                                    :foreground ,terminal-monokai-original-bg))))
   ...
   ;; hl-line-mode
   `(hl-line
     ((,class (:background ,monokai-original-hl-line
                           :inherit t))
      (,terminal-class (:background ,terminal-monokai-original-hl-line
                                    :inherit t))))
   ...
   `(markdown-header-face-3
     ((,class (:inherit markdown-header-face
                        :height ,monokai-original-height-plus-2))
      (,terminal-class (:inherit markdown-header-face
                                 :height ,monokai-original-height-plus-2))))
   ...
   `(org-agenda-structure
     ((,class (:foreground ,monokai-original-emph
                           ...
                           :height ,monokai-original-height-plus-1
                           :underline nil
                           :box (:line-width 2 :color ,monokai-original-bg)))
      (,terminal-class (:foreground ,terminal-monokai-original-emph
                                    :background ,terminal-monokai-original-hl
                                    :weight bold
                                    :slant normal
                                    ...
                                    :height ,monokai-original-height-plus-1
                                    :underline nil
                                    :box (:line-width 2 :color ,terminal-monokai-original-bg)))))
   ...
   `(org-agenda-date
     ((,class (:foreground ,monokai-original-comments
      ...
      (,terminal-class (:foreground ,terminal-monokai-original-comments
                                    ...
                                    :slant normal
                                    :height 1.0
                                    :box (:line-width 2 :color ,terminal-monokai-original-bg)))) t)
   ...
   `(org-agenda-date-today
     ((,class (:inherit org-agenda-date
      ...
      (,terminal-class (:inherit org-agenda-date
                                 ...
                                 :box unspecified
                                 :foreground ,terminal-blue
                                 :background ,terminal-monokai-original-bg))) t)
   ...
   ;; parenface
   `(paren-face
     ((,terminal-class (:foreground ,monokai-original-comments))))
   ...
   `(popup-scroll-bar-foreground-face
     ((,class (:background ,monokai-original-emph))
      (,terminal-class (:background ,terminal-monokai-original-emph))))
   ...
   `(yascroll:thumb-text-area
     ((,class (:foreground ,monokai-original-comments
                           :background ,monokai-original-comments))
      (,terminal-class (:foreground ,terminal-monokai-original-comments
                                    :background ,terminal-monokai-original-comments))))
   ...
   `(zencoding-preview-input
     ((,class (:background ,monokai-original-hl
                           :box ,monokai-original-emph))
      (,terminal-class (:background ,terminal-monokai-original-hl
                                    :box ,terminal-monokai-original-emph)))))

  (custom-theme-set-variables
   'monokai-original
   `(ansi-color-names-vector [,monokai-original-bg ,red ,green ,yellow
                                          ,blue ,magenta ,cyan ,monokai-original-fg])

   ;; compilation
   `(compilation-message-face 'default)

   ;; fill-column-indicator
   `(fci-rule-color ,monokai-original-hl)
   ...
   `(highlight-tail-colors
     '((,monokai-original-hl . 0)(,green-lc . 20)(,cyan-lc . 30)(,blue-lc . 50)
       (,yellow-lc . 60)(,orange-lc . 70)(,magenta-lc . 85)(,monokai-original-hl . 100)))
   ...
   ;; weechat
   `(weechat-color-list
     (unspecified ,monokai-original-bg ,monokai-original-hl
                  ,red-d ,red
                  ,green-d ,green
                  ,yellow-d ,yellow
                  ,blue-d ,blue
                  ,magenta-d ,magenta
                  ,cyan-d ,cyan
                  ,monokai-original-fg ,monokai-original-emph))))
...
(provide-theme 'monokai-original)
...
;;; monokai-original-theme.el ends here
